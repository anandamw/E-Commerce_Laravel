                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section3125">
                                    ...
                                    <ul class="_215b31">
                                        ...
                                        @if (Auth::check())
                                            <li><button class="btn_buy" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal"> Buy
                                                    Now</button>
                                            </li>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/checkout" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="text" value="{{ $atribut->harga }}"
                                                                    name="harga">
                                                                <input type="text" value="{{ $getsData->id_produks }}"
                                                                    name="produks_id">
                                                                <input type="text" value="{{ $getsData->users_id }}"
                                                                    name="users_id">
                                                            </div>
                            ...
                            @else
                                <li><button class="btn_buy" data-bs-toggle="modal" data-bs-target="#modalLogin">Buy
                                        Now</button></li>
                                @endif
                                </ul>
                                {{-- <div class="_215fgt1">
